...
for i in range(len(IR_arr)):
    ...
    ax[0][0].plot(testing_replacement_false_IR[:,0]/Q, [Ptot_approximation(x, I, S, R, Q, b, FNR, FPR) for x in Qtildep], 'k', alpha = 0.7, linewidth = 2)

ax[0][0].plot(testing_replacement_true_IR[:,0]/Q, testing_replacement_true_IR[:,1], ls = ':', color = 'LightBlue', linewidth = 2)
ax[0][0].plot(testing_replacement_true_IR[:,0]/Q, testing_replacement_true_IR[:,2], ls = ':', color = 'LightBlue', linewidth = 2)
ax[0][0].plot(testing_replacement_true_IR[:,0]/Q, testing_replacement_true_IR[:,3], ls = ':', color = 'LightBlue', linewidth = 2)
ax[0][0].plot(testing_replacement_true_IR[:,0]/Q, testing_replacement_true_IR[:,4], ls = ':', color = 'LightBlue', linewidth = 2)
ax[0][0].plot(testing_replacement_true_IR[:,0]/Q, testing_replacement_true_IR[:,5], ls = ':', color = 'LightBlue', linewidth = 2)
...
for i in range(len(b_arr)):
    ...
    ax[0][1].plot(testing_replacement_false_IR[:,0]/Q, [Ptot_approximation(x, I, S, R, Q, b_arr[i], FNR, FPR) for x in Qtildep], 'k', alpha = 0.7, linewidth = 2)

ax[0][1].plot(testing_replacement_true_b[:,0]/Q, testing_replacement_true_b[:,1], ls = ':', color = 'LightBlue', linewidth = 2)
ax[0][1].plot(testing_replacement_true_b[:,0]/Q, testing_replacement_true_b[:,2], ls = ':', color = 'LightBlue', linewidth = 2)
ax[0][1].plot(testing_replacement_true_b[:,0]/Q, testing_replacement_true_b[:,3], ls = ':', color = 'LightBlue', linewidth = 2)
ax[0][1].plot(testing_replacement_true_b[:,0]/Q, testing_replacement_true_b[:,4], ls = ':', color = 'LightBlue', linewidth = 2)
...
for i in range(len(FNR_arr)):
    ...
    ax[1][0].plot(testing_replacement_false_IR[:,0]/Q, [Ptot_approximation(x, I, S, R, Q, b, FNR_arr[i], FPR) for x in Qtildep], 'k', alpha = 0.7, linewidth = 2)
    
ax[1][0].plot(testing_replacement_true_FNR[:,0]/Q, testing_replacement_true_FNR[:,1], ls = ':', color = 'LightBlue', linewidth = 2)
ax[1][0].plot(testing_replacement_true_FNR[:,0]/Q, testing_replacement_true_FNR[:,2], ls = ':', color = 'LightBlue', linewidth = 2)
ax[1][0].plot(testing_replacement_true_FNR[:,0]/Q, testing_replacement_true_FNR[:,3], ls = ':', color = 'LightBlue', linewidth = 2)
ax[1][0].plot(testing_replacement_true_FNR[:,0]/Q, testing_replacement_true_FNR[:,4], ls = ':', color = 'LightBlue', linewidth = 2)
...
for i in range(len(FPR_arr)):
    ...
    ax[1][1].plot(testing_replacement_false_IR[:,0]/Q, [Ptot_approximation(x, I, S, R, Q, b, FNR, FPR_arr[i]) for x in Qtildep], 'k', alpha = 0.7, linewidth = 2)
    
ax[1][1].plot(testing_replacement_true_FPR[:,0]/Q, testing_replacement_true_FPR[:,1], ls = ':', color = 'LightBlue', linewidth = 2)
ax[1][1].plot(testing_replacement_true_FPR[:,0]/Q, testing_replacement_true_FPR[:,2], ls = ':', color = 'LightBlue', linewidth = 2)
ax[1][1].plot(testing_replacement_true_FPR[:,0]/Q, testing_replacement_true_FPR[:,3], ls = ':', color = 'LightBlue', linewidth = 2)
ax[1][1].plot(testing_replacement_true_FPR[:,0]/Q, testing_replacement_true_FPR[:,4], ls = ':', color = 'LightBlue', linewidth = 2)
ax[1][1].plot(testing_replacement_true_FPR[:,0]/Q, testing_replacement_true_FPR[:,5], ls = ':', color = 'LightBlue', linewidth = 2)
