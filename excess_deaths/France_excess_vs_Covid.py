...
data = pd.read_csv("../covid-19-excess-deaths-tracker/output-data/excess-deaths/france_excess_deaths.csv")

covid_deaths = data[data['region'] == 'France']
...
France_population = 66.99e6
prefactor = 1/France_population*1e5
...
ax.set_title(r'France')
ax.text(datetime.date(2020, 1, 5), 0.89*30-10, r'(c)')
ax2 = ax.twinx()
...
plt.tight_layout()
plt.savefig('France_Covid_excess.png', dpi = 480)
plt.show()